		...
		<table>
			...
			<tr>
				<th colspan="4">
					...
					<input type = "button" id="registerBtn1" onclick="location.href='./noticeboardUpdate.go?bidx=${dto.boardIdx}'" value="수정" class="btn btn-outline-dark"/>
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
					<input type = "button" id="registerBtn2" value="삭제" onclick="if(confirm('정말로 삭제하시겠습니까?')){location.href='./noticeboardDelete.do?bidx=${dto.boardIdx}';}" class="btn btn-outline-dark">			
					</c:if>
				</th>
			</tr>
		</table>
