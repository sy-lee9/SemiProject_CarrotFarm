...
<body>
	...
	<button class="btn btn-outline-dark" id ="teampictureboardSearchButton">검색</button>

	<br/>
	<br/>
	<c:if test="${loginId != null }"> <!-- teamIdx 써야할듯 -->
	<button class="btn btn-outline-dark" id="registerBtn" onclick="location.href='teampictureboardWrite.go?teamIdx=${teamIdx}'">글쓰기 등록</button>
	</c:if>
	<br/>
	<br/>
...
$(document).ready(function() {
	  $('#teampictureboardSearchButton').css('margin-top', '+0.5px');
	});
</script>
</html>