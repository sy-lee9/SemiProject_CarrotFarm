...
<style>
	...
	#inquiryboardSearchInput{
		width: 200px;
    	height: 30px;
    	
	}
	
	#inquiryboardSearchButton, #registerBtn {
		font-size: 15px;
		height: 30px;
		margin : 5px;
...
<body>
	...
	<button id ="inquiryboardSearchButton" class="btn btn-outline-dark">검색</button>
	<br/>
	<br/>
	<c:if test="${loginId != null }">
	<button id="registerBtn" class="btn btn-outline-dark" onclick="location.href='inquiryboardWrite.go'">문의 등록</button>
	</c:if>
	<br/>
	<br/>
...
$(document).ready(function() {
	  $('#inquiryboardSearchButton').css('margin-top', '+0.5px');
	});
</script>
</html>