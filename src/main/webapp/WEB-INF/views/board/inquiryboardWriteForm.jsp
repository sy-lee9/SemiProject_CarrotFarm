...
<body>
	...
	<div id="content">
	<form action="inquiryboardWrite.do" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
	<input type="hidden" name="categoryId" value="b003"/>
		<table>
			<tr>
				<th>제목</th>
				<td><input type="text" name="subject"id="subjectInput" maxlength="60" style="width : 950px ; height : 30px"
			...
			<tr>
				<th colspan="2">
					<input type = "button" onclick="location.href='./inquiryboardList.do'" value="리스트" class="btn btn-outline-dark" id="listButton"/>
					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
